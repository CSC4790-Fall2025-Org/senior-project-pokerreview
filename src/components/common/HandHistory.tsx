  ...
  return (
    <>
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
        <div className={`bg-gray-800 rounded-lg w-full max-w-6xl max-h-[90vh] flex flex-col transition-all duration-300 ${
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="mt-2 w-full bg-blue-600 hover:bg-blue-700 text-white text-sm py-1 rounded transition-colors"
                        >
                          🤖 AI Analysis
                        </button>
                      </button>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-900 rounded-lg p-4">
                    ...
                    <button
                      ...
                      className="mt-4 w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors flex items-center justify-center gap-2"
                    >
                      🤖 Get AI Analysis
                    </button>
                  </div>
